...
// 	backMenu = (
// 		<m.div initial={initial} animate={animate} exit={exit} transition={transition}>
// 			<Link href={SITE_ROUTES.home} passHref>
// 				<div title={SITE_STRINGS.backToMainPageTitle} className="icon-link-btn">
// 					<span>
// 						<BsArrowReturnLeft />
// 					</span>
// 					{SITE_STRINGS.backToMainText}
...
export function Menu({ onClick = () => {} }) {
	...
	backMenu = (
		<m.div initial={initial} animate={animate} exit={exit} transition={transition}>
			<Link href={SITE_ROUTES.home} passHref>
				<p title={SITE_STRINGS.backToMainPageTitle} className="icon-link-btn">
					<span>
						<BsArrowReturnLeft />
					</span>
					{SITE_STRINGS.backToMainText}
